...
class WorkshopPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Future(() async {
      model.startLoading();
      await model.fetchWorkshopMake(groupName, _organizer.organizerId);
      model.stopLoading();
    });
    ...
    return Card(
      ...
      child: Container(
        ...
        child: ListTile(
          ...
          subtitle: _subtitle(groupName, model, _workshop),
          trailing: InkWell(
            onTap: () {
              // Trainingへ
              Navigator.push(
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    Text("講義を編集", style: cTextListSS, textScaleFactor: 1),

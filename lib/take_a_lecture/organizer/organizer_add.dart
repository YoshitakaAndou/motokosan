...
class OrganizerAdd extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    model.organizer.organizerNo =
        model.organizers.length.toString().padLeft(4, "0");
    return Scaffold(
  ...
  Widget _number(OrganizerModel model) {
    return Text("${model.organizer.organizerNo}");
  }

  Widget _title(OrganizerModel model) {
    return TextField(
      maxLines: null,
  ...
  Widget _subTitle(OrganizerModel model) {
    return TextField(
      maxLines: null,
      textInputAction: TextInputAction.done,
      keyboardType: TextInputType.text,
  ...
  Widget _option1(OrganizerModel model) {
    return TextField(
      maxLines: null,
      textInputAction: TextInputAction.done,
      keyboardType: TextInputType.text,
  ...
  Widget _option2(OrganizerModel model) {
    return TextField(
      maxLines: null,
      textInputAction: TextInputAction.done,
      keyboardType: TextInputType.text,
  ...
  Widget _option3(OrganizerModel model) {
    return TextField(
      maxLines: null,
      textInputAction: TextInputAction.done,
      keyboardType: TextInputType.text,

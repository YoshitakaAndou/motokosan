...
import '../../question/play/question_list_page.dart';
...
class _LecturePlayState extends State<LecturePlay> {
  ...
  Future<void> _saveLectureResult(BuildContext context) async {
    widget._lectureList.lectureResult.lectureId =
        widget._lectureList.lecture.lectureId;
    widget._lectureList.lectureResult.isTaken = "受講済";
    widget._lectureList.lectureResult.questionCount = 0;
    widget._lectureList.lectureResult.correctCount = 0;
    widget._lectureList.lectureResult.isTakenAt =
        ConvertItems.instance.dateToInt(DateTime.now());
    await LectureDatabase.instance
        .saveValue(widget._lectureList.lectureResult, false);
  }
}

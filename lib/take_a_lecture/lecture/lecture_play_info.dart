          ...
          content: Column(
            ...
            children: [
              ...
              if (_lectureList.lecture.allAnswers == '全問解答が必要')
                _columnItem("問題数", '${_lectureList.lecture.questionLength}'),
              if (_lectureList.lecture.allAnswers == '全問解答が必要')
                _columnItem("合格点", '${_lectureList.lecture.passingScore}点'),
              Divider(thickness: 1, height: 5, color: Colors.white),
              _columnItem(
                "主催者名",

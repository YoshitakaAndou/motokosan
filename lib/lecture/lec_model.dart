...
class LecModel extends ChangeNotifier {
  ...
  List<Lecture> datesDb = List();
  List<Lecture> datesFb = List();
  List<Lecture> datesSg = List();
  List<Lecture> dates01 = List();
  List<Lecture> dates02 = List();
  List<Lecture> dates03 = List();
  List<Lecture> dates04 = List();
  List<Lecture> dates05 = List();
  ...
  void initBeforeEditing(Lecture _qa) {
  ...
  void setDatesSg(List<Lecture> _dates) {
    datesSg = _dates;
    notifyListeners();
  }
